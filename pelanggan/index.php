        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 px-4">
                    ...
                    <h1 class="display-3 fw-bold mb-4">Kelezatan Tradisi, <br><span class="text-maroon">Sentuhan Modern.</span></h1>
                    ...
                    <div class="d-flex gap-3 align-items-center">
                        <a href="login.php" class="btn btn-maroon shadow-lg">Lihat Katalog Menu</a>
                    </div>
                </div>
                ...
                <div class="col-lg-6 mt-5 mt-lg-0">
                    <div class="image-wrapper p-4 text-center">
                        ...
                        <div class="stat-card">
                            <div class="bg-maroon p-3 rounded-circle text-white">
                                🍽️
                            </div>
                            <div>
    ...
    <section id="menu" class="py-5">
        <div class="container">
            <div class="text-center mb-5">
                <span class="text-maroon fw-bold text-uppercase small" style="letter-spacing: 2px;">Pilihan Terbaik</span>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden menu-card">
                        <div class="position-relative">
                            ...
                            <span class="position-absolute top-0 end-0 m-3 badge bg-maroon px-3 py-2 rounded-pill">Best Seller</span>
                        </div>
                        <div class="card-body p-4">
                            <h5 class="card-title fw-bold">Ayam Bakar Madu Spesial</h5>
                            <p class="card-text text-muted small">Ayam pejantan pilihan dibakar dengan bumbu madu rahasia, disajikan dengan sambal bajak dan lalapan segar.</p>
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                <span class="fw-bold text-maroon fs-5">Rp 35.000</span>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden menu-card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                <span class="fw-bold text-maroon fs-5">Rp 45.000</span>
                                <a href="login.php" class="btn btn-outline-dark btn-sm rounded-pill px-3">Pesan</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 border-0 shadow-sm rounded-4 overflow-hidden menu-card">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-4">
                                <span class="fw-bold text-maroon fs-5">Rp 50.000</span>
                                <a href="login.php" class="btn btn-outline-dark btn-sm rounded-pill px-3">Pesan</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center mt-5">
                <a href="login.php" class="btn btn-maroon px-5 py-3 shadow">Lihat Semua Menu Lengkap</a>
            </div>
        </div>
    </section>
